...
public class HistoryActivity extends AppCompatActivity {
    ...
    private void setUIRef() {
        ...
        //Create adapter
        //Handling clicks
        SubRecycleritemArrayAdapter myRecyclerViewAdapter = new SubRecycleritemArrayAdapter(locationItem, HistoryActivity.this, locationItem -> {
        ...
        for (int i = 0; i < historyItems.size(); i++) {
            for (int a = 0; a < historyItems.get(i).size(); a++) {
                ...
                JsonObjectRequest objectRequest = new JsonObjectRequest(
                        Request.Method.GET,
                        "https://maps.googleapis.com/maps/api/place/details/json?place_id=" + historyItems.get(i).get(a).getPlaceId() + "&fields=photos,name,rating,vicinity,reviews&key=AIzaSyCck4O2J1amBwQVr0soFFaQcOmDiYvwY1A",
                        null,
                        response -> {
                            try {
